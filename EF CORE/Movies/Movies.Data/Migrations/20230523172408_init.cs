    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Nuri Bilge", null, "Ceylan" });

            migrationBuilder.InsertData(
                table: "Players",
                columns: new[] { "Id", "FirstName", "Info", "LastName" },
                values: new object[] { 1, "Doğu", null, "Demirkol" });

            migrationBuilder.InsertData(
                table: "Movies",
                columns: new[] { "Id", "DirectorId", "Duration", "Name", "Poster", "PublishDate", "Rating" },
                values: new object[] { 1, 1, null, "Ahlat Ağacı", null, null, null });

            migrationBuilder.InsertData(
                table: "MoviesPlayer",
                columns: new[] { "MovieId", "PlayerId", "Role" },
                values: new object[] { 1, 1, "Sinan Karasu -> Bir öğretmen mezunu" });
