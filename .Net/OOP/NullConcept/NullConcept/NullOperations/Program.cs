...
Address address3 = address1; //referanslari ayni yani adresleri 

Console.WriteLine($"address1==address2 sonucu: {address1 == address2}");//aynı adres mi diye kontrol ediyor ve false donuyor
...
Console.WriteLine($"deney1 ==  deney2 ile: {deney1 == deney2}");
...
Console.WriteLine(address ?? new Address { City = "Burdur" });//adres yoksa tanımlıyoruz
